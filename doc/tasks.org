...
**** TODO try: Access-Control-Allow-Origin: http://example.com:8080 http://foo.example.com
**** TODO try: http://loggly.com/blog/2011/12/enabling-cors-in-django-piston/
   + /django access-control-allow-origin/ -> https://gist.github.com/426829
**** use [[Live HTTP Headers]]
**** TODO try http://blog.101ideas.cz/posts/subdomains-in-django-an-example.html
